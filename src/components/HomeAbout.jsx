...
const HomeAbout = () => {
  return (
    <section className="bg-white px-4 md:mt-24">
      <div className="max-w-7xl mx-auto">
        {/* Heading Section */}
        <div className="text-center md:mb-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Welcome to Olympians Labortaries</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          {/* Right Content */}
          <div className="flex flex-col items-center text-center md:text-left mb-20">
